...
export default {
  ...
  methods: {
    ...
    async getComments () {
      const { data: { data: { list, total } } } = await getProComments(this.goodsId, 3)
      // console.log(res)
      // console.log(list)
    ...
    async addCart () {
      ...
      const { data: { data: { cartTotal } } } = await addCart(this.goodsId, this.addCount, this.detail.skuList[0].goods_sku_id)
      // console.log(res)
